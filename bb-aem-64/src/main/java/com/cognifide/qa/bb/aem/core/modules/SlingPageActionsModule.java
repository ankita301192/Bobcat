...
public class SlingPageActionsModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    slingPageActions.addBinding(AemActions.CREATE_PAGE_VIA_SLING).to((Class<? extends ActionWithData>) CreatePage.class);
    slingPageActions.addBinding(AemActions.DELETE_PAGE_VIA_SLING).to((Class<? extends ActionWithData>) DeletePage.class);
  }
}
