 ...
 * #L%
 */
package com.cognifide.qa.bb.aem.core.utils;

import com.cognifide.qa.bb.aem.core.webelement.BobcatDefaultElementLocatorFactory;
...
//    elementLocatorFactory = new WebElementScopedLocatorFactory(webDriver, scope, injector);
    elementLocatorFactory = new WebElementScopedLocatorFactory(webDriver , scope, injector);
    stack.push(new PageObjectContext(elementLocatorFactory, framePath));
    try {
      return injector.getInstance(clazz);
